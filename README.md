...
```javascript
import dapxsumors from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dapxsumors@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dapxsumors/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dapxsumors/actions/workflows/test.yml?query=branch:v0.2.0
